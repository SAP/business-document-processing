...
MODEL_TYPE_DEFAULT_1 = 'default_model_1'
MODEL_TYPE_DEFAULT_2 = 'default_model_2'
MODEL_TYPE_LLM = 'llm_model'
MODEL_TYPE_TEMPLATE = 'template_model'
MODEL_TYPE_CUSTOM = 'custom_model'
...
SCHEMAS_VERSIONS_ENDPOINT = '/schemas/{schemaId}/versions'
...
SETUP_TYPE_MODEL = 'model'

SUPPORTED_MODEL_TYPES = [
    MODEL_TYPE_DEFAULT_1,
    MODEL_TYPE_DEFAULT_2,
    MODEL_TYPE_LLM,
    MODEL_TYPE_TEMPLATE,
    MODEL_TYPE_CUSTOM
]
